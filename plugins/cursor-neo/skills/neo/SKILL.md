...
description: >-
  ...
  guidance; persistent memory is opt-in for external-provider calls. Skip for
  questions answerable from the context already selected, factual lookups, and
  mechanical edits — each run costs 5-30s and an external-provider call.
